...
public interface LawyerRepository extends JpaRepository<Lawyer, Long> {
    ...
    //obs. customers_number need has renamed as customersNumber because are in projections how customersNumber
    //obs. JPQL don't have UNION. better write query in SQL in this case, when have UNION don't take in JPQL but in SQL.
